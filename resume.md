...
- Wrote jobs/background tasks using hangfire to carry out recurrent services.
...
- Wrote  RCW(Runtime Callable Wrapper) for third party COM based hardware drivers/sdks interop. 
